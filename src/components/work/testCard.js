...
import testcardImage from "./static/testcardImage.jpg";
  ...
  return (
    <Card className={classes.root} style={{ boxShadow: "1px 1px black" }}>
      <a href="/" target="_blank" rel="noreferrer" style={{ textDecoration: "none" }}>
        <CardHeader title="Demo Card" subheader="July 2021" id="cardtop" />
      </a>
      <CardMedia className={classes.media} image={testcardImage} title="BananaDog" label="image" />
